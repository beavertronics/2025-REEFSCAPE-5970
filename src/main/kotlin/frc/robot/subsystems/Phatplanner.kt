...
object Phatplanner : SubsystemBase() {
    ...
    fun getAutonomousCommand(): Command {
        return RobotController.autoChooser.selected
    }
    ...
    init {
        ...
        autoChooser = AutoBuilder.buildAutoChooserWithOptionsModifier { stream: Stream<PathPlannerAuto> ->
            if (isCompetition
        ...
        //NamedCommands.registerCommand("autoBalance", swerve.autoBalanceCommand()); todo
